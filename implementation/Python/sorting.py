...
def bubble_sort(arr: List[int]) -> List[int]:
    """
    An implementation of the bubble sort algoirthm(aka sinking sort) used to
    arrange a mutable sequence of integers in a particular order.
...
def selection_sort(arr: List[int]) -> List[int]:
    """
    An implementation of the selection sort algorithm used to arrange mutable
    sequences into in a particular order.
    ...
    for i, _ in enumerate(arr):
        ...
        arr[i], arr[index_of_minimum_value] = (
            arr[index_of_minimum_value],
            arr[i],
        )
    return arr
...
def insertion_sort(arr: List[int]) -> List[int]:
    """
    An implementation of the insertion sort algorithm used to arrange mutable
    sequences into in a particular order
...
def merge(first_array: List[int], second_array: List[int]) -> List[int]:
    ...
    Returns:
        List[int]: Sorted array containing all the elements of the two input
        arrays.
    """
    first_arr_counter = 0
    ...
    new_arr_counter = 0
    while first_arr_counter < len(first_array) and second_arr_counter < len(
        second_array
    ):
...
def merge_sort(arr: List[int]) -> List[int]:
    """
    An implementation of the merge sort algorithm used to arrange a sequence in
    a particular order.
...
def bucket_sort(arr: List[int]) -> List[int]:
    """
    Implementation of the bucket sort algorithm used to arrange a sequence in a
    particular order.
    ...
    for element in arr:
        if element == 0:
            ...
            bucket_index = (
                math.ceil((element * number_of_buckets) / maximum_value) - 1
            )
